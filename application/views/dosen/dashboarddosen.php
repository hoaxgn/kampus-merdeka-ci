        ...
        <div class="col s12 m3">
            <div class="card ">
                <div class="card-content center">
                    <img src="<?php echo base_url(); ?>assets/img/avatar-10.png">
                    <br>
                    <h5>Pak Agus</h5>
                    <h6>Dosen</h6>
                    <br>
            ...
            <div class="row">
                <div class="col s12 m2">
                    <div class="card-panel hoverable">
                        <a href="<?php echo base_url(); ?>v_program/kegiatan">
                ...
                <div class="col s12 m2">
                    <div class="card-panel hoverable">
                        <a href="<?php echo base_url(); ?>v_program/Magang">
                ...
                <div class="col s12 m2">
                    <div class="card-panel hoverable">
                        <a href="<?php echo base_url(); ?>v_program/Kkn">
                ...
                <div class="col s12 m2">
                    <div class="card-panel hoverable">
                        <a href="<?php echo base_url(); ?>v_program/Mengajar">
                ...
                <div class="col s12 m2">
                    <div class="card-panel hoverable ">
                        <a href="<?php echo base_url(); ?>v_program/Riset">
                ...
                <div class="col s12 m2">
                    <div class="card-panel hoverable">
                        <a href="<?php echo base_url(); ?>v_program/Proyek">
                ...
                <div class="col s12 m2">
                    <div class="card-panel hoverable">
                        <a href="<?php echo base_url(); ?>v_program/Studi">
                ...
                <div class="col s12 m2">
                    <div class="card-panel hoverable">
                        <a href="<?php echo base_url(); ?>v_program/Pertukaran">
